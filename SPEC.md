# Especificacao Tecnica — Nextjs Frontend

| Field | Value |
|---|---|
| Repository | `nextjs_frontend_example` |
...
Frontend application (SPA) consuming the platform API. This document describes requirements, architecture, and acceptance criteria.
