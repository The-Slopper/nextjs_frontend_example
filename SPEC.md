...
| Campo | Valor |
|---|---|
| Repositorio | `nextjs_frontend_example` |
...
Aplicacao frontend (SPA) consumindo a API da plataforma. Este documento descreve requisitos, arquitetura e criterios de aceite.
